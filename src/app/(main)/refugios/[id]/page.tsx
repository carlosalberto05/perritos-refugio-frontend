...
import { useShelter } from '@/api/shelters';
import { useDogsByShelterId } from '@/api/dogs';
...
export default function ShelterPage({ params }: PageProps) {
  ...
  const {
    ...
    error: shelterError,
  } = useShelter(resolvedParams.id);

  const {
    data: shelterDogs,
    isLoading: isDogsLoading,
    error: dogsError,
  } = useDogsByShelterId(resolvedParams.id);
  ...
  if (isShelterLoading || isDogsLoading) {
    return (
  ...
  if (shelterError || dogsError) {
    const error = shelterError || dogsError;
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
            ...
            <div className="flex-grow text-white pb-4 sm:pb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 text-white/90">
                ...
                <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-md px-3 py-1 rounded-full border border-white/10">
                  ...
                  <span className="text-sm font-medium">
                    {shelter.rescuedCount} perritos bajo su cuidado
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-[2rem] p-8 text-white shadow-xl shadow-orange-500/20 relative overflow-hidden group">
              ...
              <p className="text-white/90 text-sm font-medium mb-8 relative z-10">
                Cada donación va directamente a la alimentación, medicinas y
                cuidados de nuestros rescatados.
              </p>
              <Button
                variant="primary"
                fullWidth
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100">
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <Link
                  href="/"
                  className="flex items-center justify-center gap-2 text-blue-600 font-bold hover:gap-3 transition-all"
                >
